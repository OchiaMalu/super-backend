...
public class BloomFilterSearchAdvice {
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* top.ochiamalu.controller.UserController.getUserById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* top.ochiamalu.controller.TeamController.getTeamById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* top.ochiamalu.controller.TeamController.getTeamMemberById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* top.ochiamalu.controller.BlogController.getBlogById(..))")
